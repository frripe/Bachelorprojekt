...
# #
# #     # rm -r    merge_metrics/lv-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/
# #     # mkdir -p merge_metrics/lv-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/
# #     # python3  merge_metrics/merge_data.py merge_metrics/cpbd_HF/many_alpha/alpha_1/      laplacian_variance/output/png/ merge_metrics/lv-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/ ${alpha}
# #     # rm -r    merge_metrics/lv-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/
# #     # mkdir -p merge_metrics/lv-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/
# #     # python3  merge_metrics/merge_data.py merge_metrics/cpbd_HF/many_alpha/alpha_1/      laplacian_variance/output/jpg/ merge_metrics/lv-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/ ${alpha}
# #     #
# #     # rm -r    merge_metrics/HF-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/
# #     # mkdir -p merge_metrics/HF-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/
# #     # python3  merge_metrics/merge_data.py merge_metrics/cpbd_lv_jpg/many_alpha/alpha_4/  Histogram-Frequency-based/output/ merge_metrics/HF-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/ ${alpha}
# #     # rm -r    merge_metrics/HF-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/
# #     # mkdir -p merge_metrics/HF-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/
# #     # python3  merge_metrics/merge_data.py merge_metrics/cpbd_lv_png/many_alpha/alpha_4/  Histogram-Frequency-based/output/ merge_metrics/HF-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/ ${alpha}
# #     #
# #     # rm -r    merge_metrics/cpbd-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/
# #     # mkdir -p merge_metrics/cpbd-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/
# #     # python3  merge_metrics/merge_data.py merge_metrics/HF_lv_jpg/many_alpha/alpha_8/    cpbd/output/ merge_metrics/cpbd-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/ ${alpha}
# #     # rm -r    merge_metrics/cpbd-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/
# #     # mkdir -p merge_metrics/cpbd-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/
# #     # python3  merge_metrics/merge_data.py merge_metrics/HF_lv_png/many_alpha/alpha_8/    cpbd/output/ merge_metrics/cpbd-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/ ${alpha}
# #
# #
# #     # python3 visualize_output.py merge_metrics/lv-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/   > merge_metrics/lv-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/results.txt
# #     # python3 visualize_output.py merge_metrics/lv-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/   > merge_metrics/lv-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/results.txt
# #     # python3 visualize_output.py merge_metrics/HF-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/   > merge_metrics/HF-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/results.txt
# #     # python3 visualize_output.py merge_metrics/HF-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/   > merge_metrics/HF-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/results.txt
# #     # python3 visualize_output.py merge_metrics/cpbd-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/ > merge_metrics/cpbd-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/results.txt
# #     # python3 visualize_output.py merge_metrics/cpbd-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/ > merge_metrics/cpbd-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/results.txt
# #
# #     # python3 visualize_stats.py merge_metrics/lv-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/
# #     # python3 visualize_stats.py merge_metrics/lv-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/
# #     # python3 visualize_stats.py merge_metrics/HF-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/
# #     # python3 visualize_stats.py merge_metrics/HF-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/
# #     # python3 visualize_stats.py merge_metrics/cpbd-cpbd_HF_lv_png/many_alpha/alpha_${alpha}/
# #     # python3 visualize_stats.py merge_metrics/cpbd-cpbd_HF_lv_jpg/many_alpha/alpha_${alpha}/
# done
