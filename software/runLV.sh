...
for type in 'jpg' 'png'; do
    ...
    python3 laplacian_variance/process.py -i ../dataset/training/${type}/NoProblems_copy/        > laplacian_variance/output/${type}/out_no_problems.txt
    ...
    python3 laplacian_variance/process.py -i ../dataset/training/${type}/synth_no_problems_copy/ > laplacian_variance/output/${type}/out_synth_no_problems.txt
